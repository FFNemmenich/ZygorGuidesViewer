...
condition_suggested=function() return skill('Blacksmithing') > 0 and skill('Pandaren Blacksmithing') < 75 end,
},[[
step
...
|tip Inside the building.
buy 1 Pattern: Contender's Leather Bracers##86250 |goto Shrine of Seven Stars/1 76.53,48.46
|only if skill("Pandaria Leatherworking") < 75
step
