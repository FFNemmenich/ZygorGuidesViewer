...
step
Load the "Meaty Haunch" guide |confirm |next "Zygor's Profession Guides\\Cooking\\Farming Guides\\Meaty Haunch"
|tip Click the line above to load the guide.
...
only if skill("Zandalari Cooking") < 150
step
Load the "Stringy Loins" guide |confirm |next "Zygor's Profession Guides\\Cooking\\Farming Guides\\Stringy Loins"
|tip Click the line above to load the guide.
|tip You will need the "Fishing" skill in order to utilize the guide.
