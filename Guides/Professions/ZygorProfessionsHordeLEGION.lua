...
step
Load the "Legion Blacksmithing Quest Line" Guide |confirm |next "Zygor's Profession Guides\\Blacksmithing\\Quest Guides\\Legion Blacksmithing Quest Line"
|tip Click the line above to load the guide.
...
ZGV.BETASTART()
ZygorGuidesViewer:RegisterGuide("Zygor's Profession Guides\\Cooking\\Leveling Guides\\Legion Cooking 1-100",{
author="support@zygorguides.com",
...
step
Load the "Legion Cooking Quest Line" Guide |confirm |next "Zygor's Profession Guides\\Cooking\\Quest Guides\\Legion Cooking Quest Line"
|tip Click the line above to load the guide.
...
step
Load the "Enchanting Quest Line" Guide |confirm |next "Zygor's Profession Guides\\Enchanting\\Quest Guides\\Legion Enchanting Quest Line"
|tip Click the line above to load the guide.
...
step
Load the "Legion Engineering Quest Line" Guide |confirm |next "Zygor's Profession Guides\\Engineering\\Quest Guides\\Legion Engineering Quest Line"
|tip Click the line above to load the guide.
...
step
Load the "Legion Inscription Quest Line" Guide |confirm |next "Zygor's Profession Guides\\Inscription\\Quest Guides\\Legion Inscription Quest Line"
|tip Click the line above to load the guide
...
step
Load the "Court of Farondis" Reputation Guide |confirm |next "Zygor's Reputations Guides\\Legion Reputations\\Court of Farondis"
|tip Click the line above to load the guide.
...
step
Load the "Legion Leather Working Quest Line" Guide |confirm |next "Zygor's Profession Guides\\Leatherworking\\Quest Guides\\Legion Leatherworking Quest Line"
|tip Click the line above to load the guide.
