...
ZygorGuidesViewer:RegisterInclude("H_Lunar_Festival_Achievements",[[
	...
	step
		Use the Festival Firecrackers as fast as you can
	...
	step
		...
		Earn The Rockets Red Glare Achievement |achieve 1281 |goto 30.6,18.9
	step
		talk Valadar Starsong##15864
...
ZygorGuidesViewer:RegisterInclude("H_Children's_Week_Ogrimmar_Quests",[[
	...
	step
		Follow the path through the Royal Quarter |goto Undercity/0 52.1,64.3 < 10
		Use your Human Orphan Whistle to summon your Human Orphan |use Human Orphan Whistle##18597
...
ZygorGuidesViewer:RegisterInclude("H_Children's_Week_Shattrath_Quests",[[
	...
	step
		Enter the Caverns of Time here |goto Tanaris 64.9,50.0 < 20
		Follow the path down |goto Tanaris/18 53.2,56.8
...
ZygorGuidesViewer:RegisterInclude("H_Children's_Week_Achievements",[[
	...
	step
		...
		This cannot be earned with World Quests at the moment
