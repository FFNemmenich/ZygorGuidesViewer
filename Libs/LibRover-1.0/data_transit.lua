...
---------------
	...
	"Northern Stranglethorn/0 37.54,50.99 <subtype:cityportal> -to- Undercity/0 84.58,16.33 {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('Old Undercity')}",

	-- Northern Stranglethorn Vale, Kalimdor -to- Tirisfal Glades, Eastern Kingdoms (After Destruction) --
	"Northern Stranglethorn/0 37.54,50.99 <subtype:cityportal> -to- Tirisfal Glades/0 69.30,62.75 {fac:H} {mode:PORTAL} {cond:not ZGV.InPhase('Old Undercity')}",
	...
	"Tirisfal Glades/0 61.88,59.01 -to- Northern Stranglethorn/0 37.23,50.48 {fac:H} {mode:PORTAL} {title:Click the Portal to Grom'gol} {cond:ZGV.InPhase('Old Undercity')}",

	-- Tirisfal Glades, Eastern Kingdoms -to- Orgrimmar - Durotar, Kalimdor --
	"Tirisfal Glades/0 60.74,58.67 <subtype:cityportal> -to- Orgrimmar/2 48.28,64.53 {fac:H} {mode:PORTAL} {cond:ZGV.InPhase('Old Undercity')}",

	-- Tirisfal Glades, Eastern Kingdoms -to- Vengeance Landing - Howling Fjord, Northrend --
	"Tirisfal Glades/0 59.09,58.91 -to- Howling Fjord/0 79.00,28.92 {fac:H} {mode:PORTAL} {title:Click the Portal to Howling Fjord} {cond:ZGV.InPhase('Old Undercity')}",
	...
	"Dalaran L/10 38.29,65.57 -to- Darnassus/0 43.47,78.68 {fac:A} {mode:PORTAL}"..
		"{title:Click the Portal to Darnassus inside Greyfang Enclave} {cond:ZGV.IsLegionOn() and ZGV.InPhase('Old Darnassus')}",



	-- Dalaran, Broken Isles -to- Darkshore, Kalimdor --
	"Dalaran L/10 38.29,65.57 -to- Darkshore/0 47.43,18.01 {fac:A} {mode:PORTAL}"..
		"{title:Click the Portal to Darnassus inside Greyfang Enclave} {cond: not ZGV.InPhase('Old Darnassus')}",
	...
	---------------
		...
		"Boralus/0 69.76,15.64 -to- Silithus/0 41.41,45.19 {fac:A} {mode:PORTAL} {title:Click the Portal to Silithus Inside the Building} {cond:ZGV.InPhase('bfa') and UnitLevel('player')>=120}",
...
-----------------
	...
	"Suramar/0 34.93,47.82 -x- Suramar/0 36.19,47.09 <region:suramar_shalaran> {template:atob} {title_atob:Follow the corridor into the cave} {title_btoa:Follow the corridor out of the cave}",
		...
		-- Portal from Shal'Aran to Astravar Harbor and back
	...
	-- PANDARIA
		...
		"Shrine of Seven Stars/2 68.5,52.8 -to- Shattrath City 54.97,40.23 {fac:A} {mode:PORTAL}",
		"Shrine of Seven Stars/2 70.8,30.6 -to- The Exodar 47.62,59.82 {fac:A} {mode:PORTAL}",
		"Shrine of Seven Stars/2 77.2,43.5 -to- Darnassus 43.47,78.67 {fac:A} {mode:PORTAL}",
		"Shrine of Seven Stars/2 74.0,40.8 -to- Ironforge 25.51,08.43 {fac:A} {mode:PORTAL}",
		"Shrine of Seven Stars/2 71.6,35.8 -to- @sw_tp_dst {fac:A} {mode:PORTAL}",
	...
	-- Capital portals
		...
		"Silvermoon City/0 49.49,14.80 -x- Tirisfal Glades/0 59.45,67.44 <region:undercitycourt> {fac:H} {mode:PORTAL} {title:Click the Orb of Translocation} {cond:ZGV.InPhase('Old Undercity')}",
		"Silvermoon City/0 49.49,14.80 -to- Tirisfal Glades/0 69.30,62.75 {fac:H} {mode:PORTAL} {title:Click the Orb of Translocation} {cond:not ZGV.InPhase('Old Undercity')}",
